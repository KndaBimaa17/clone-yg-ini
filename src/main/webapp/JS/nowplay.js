 const urlParams = new URLSearchParams(window.location.search);
    ...
    const movies = {
        ...
        conan: {
            ...
            rating: '4 *',
            ageRating: 'SU',
            synopsis: `High school student Kuroha Kaido discovers his late father's secret life as the Phantom Thief Kid, inherits his costume, and embarks on a quest to uncover the mysterious organization behind his father'sÂ murder.`
        },
        theplot: {
            ...
            rating: '3 *',
            ageRating: '13+',
            synopsis: `The story is about a hitman named Brain who suffers an accident during a murder and struggles to survive while suspecting everyone around him to find out who is behind the accident after barelyÂ surviving.`
        },
        ipar: {
