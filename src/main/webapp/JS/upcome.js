const urlParams = new URLSearchParams(window.location.search);
    ...
    const movies = {
        exorcism: {
            ...
            synopsis: `A troubled actor begins to exhibit a disruptive behavior while shooting a horror film. His estranged daughter wonders if he's slipping back into his past addictions or if there's something more sinisterÂ atÂ play.`
        },
        despicableme4: {
            ...
            synopsis: `Gru, Lucy, Margo, Edith, dan Agnes siap menyambut anggota baru di keluarga. Di tengah kebahagiaan, Gru harus menghadapi penjahat bernama Maxime Le Mal yang berniat membalas dendam kepada Gru. Apakah Gru bisa menyelamatkan keluargaÂ kecilnya?`
    },
        twisters: {
            ...
            synopsis: `Tyler Owens (Glen Powell) and Kate Cooper (Daisy Edgar-Jones) are hurricane researchers and storm chasers who put their lives on the line in an effort to test a warning system that can mitigate Oklahoma's frequentÂ hurricanes.`
    },
        deadpool: {
            ...
            synopsis: `The irresponsible Deadpool or Wade Wilson (Ryan Reynolds) is trusted to change the history of the Marvel Cinematic Universe (MCU) with Wolverine (Hugh Jackman). They work together to defeatÂ aÂ commonÂ enemy.`
    },
        myboo: {
